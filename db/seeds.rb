...
EventCreator.create(user_id:1)
EventCreator.create(user_id:2)
...
StartDatePoll.create(event_id:1)
StartDatePoll.create(event_id:2)
StartDateOption.create(possiblestartdate:"2020-07-20",start_date_poll_id:1)
StartDateOption.create(possiblestartdate:"2020-07-22",start_date_poll_id:1)
StartDateOption.create(possiblestartdate:"2020-08-14",start_date_poll_id:2)
StartDateOption.create(possiblestartdate:"2020-08-18",start_date_poll_id:2)
...
SystemAdministrator.create(user_id:1)
