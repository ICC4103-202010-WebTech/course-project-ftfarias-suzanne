Rails.application.routes.draw do
  ...
  resources :event_reports, default: { format: :html}
  resources :comment_reports, default: { format: :html}
  resources :organization_reports, default: { format: :html}
  resource :total_report, default: { format: :html}
